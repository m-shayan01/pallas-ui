...
description: Size and spacing tokens definitions used in Pallas UI design system
order: 3
---
<ContentContainer>
<Section gap="1">
...
<Paragraph size={'extraLarge'} color={'tertiary'}>Size and spacing tokens definitions used in Pallas UI design system.</Paragraph>
