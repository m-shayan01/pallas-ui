        ...
        <div className={css({
          ...
          <nav className={css({
            ...
            <Link 
              ...
              className={css({
                color: pathname.startsWith('/docs') && !pathname.startsWith('/docs/components') ? 'primary' : 'text.secondary',
                fontWeight: 'medium',
            ...
            <Link 
              ...
              className={css({
                color: pathname.startsWith('/docs/components') ? 'primary' : 'text.secondary',
                fontWeight: 'medium',
                _hover: { color: 'primary.hover' },
              })}
            >
