...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${notoSansJP.variable} ${raleway.variable}`}>
      <body>
        <div
          className={css({
            // minH: '100vh',
            // display: 'flex',
            // flexDir: 'column',
            bg: 'surface.container', //to make the background of header white instead of layout color
          })}
        >
          {/* Header container with padding to center the rounded header */}
          <div
            className={css({
